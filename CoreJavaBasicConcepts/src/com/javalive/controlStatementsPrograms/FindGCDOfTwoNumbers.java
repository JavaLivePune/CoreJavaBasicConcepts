...
that divides both the numbers without leaving any remainder. For example. GCD of 30 and 
45 is 15. GCD also known as HCF (Highest Common Factor). In this tutorial we will write 
couple of different Java programs to find out the GCD of two numbers.*/

/*How to find out the GCD on paper?
To find out the GCD of two numbers we multiply the common factors as shown 
Factors of number 30: 2*3*5
Factors of number 250: 2*5*5*5
GCD of 30 and 50 is = multiply common factors
 					= 2*5
 					= 10
*/
