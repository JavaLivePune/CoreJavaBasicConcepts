...
public class NumberToWordDemoForDebugging {
	public static void main(String[] args) {
		NumberToWord.convert_to_words("1112".toCharArray());
		/*
		 * NumberToWord.convert_to_words("523".toCharArray());
		 * NumberToWord.convert_to_words("89".toCharArray());
		 * NumberToWord.convert_to_words("8989".toCharArray());
		 */
	}
}
